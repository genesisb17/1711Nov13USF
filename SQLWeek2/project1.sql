...
(
  ...
  constraint fk_2 FOREIGN KEY(U_ID) REFERENCES ers_users(U_ID),
  constraint fk_3 FOREIGN KEY(REIMB_STATUS_ID) REFERENCES ERSREIMBURSEMENTSTATUS(REIMB_STATUS_ID),
  constraint fk_4 FOREIGN KEY(REIMB_TYPE_ID) REFERENCES ERS_REIMBURSEMENT_TYPE(REIMB_TYPE_ID),
  constraint fk_5 FOREIGN KEY(U_ID2) REFERENCES ers_users(U_ID)
  );
