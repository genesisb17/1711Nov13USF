...
export class TodoDataService {
  ...
  /*
    ...
    useful for many reasons, including the fact that is allows us 
  ...
  */
  ...
  deleteTodoById(id: number): TodoDataService{
    this.todos = this.todos.filter(todo => todo.id !== id); // filter returns everything that is not the thing you are looking for
    return this;
  }

  // simpulate GET /todos/:id
...
/*
Here we do introduce some new concepts in terms of arrow notation, filters, specidied return types, etc

HOWEVER: the main takeaway is that we have centralized our buisiness logic in one place
*/