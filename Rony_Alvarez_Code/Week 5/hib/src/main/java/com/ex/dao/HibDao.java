...
public class HibDao {
	...
	/*
	 * CRITERIA API
	 * - Criteria is a simplified API for retrieving entities by composing Criteria objects.
	 *  This very convenient approach for functionality like "search" where there is a variable number of
