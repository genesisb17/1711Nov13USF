...
public class Reimbursement {
	...
	public Reimbursement(int id, int authorId, int resolverId, int status, int type, double amount,
			Timestamp submitted, Timestamp resolved, String description, Image receipt) {
		super();
		this.id = id;
