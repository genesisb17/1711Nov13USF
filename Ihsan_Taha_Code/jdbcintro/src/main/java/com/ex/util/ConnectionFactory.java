...
public class ConnectionFactory {
	...
	public Connection getConnection() {
		...
		try {
			prop.load(new FileReader("C:/Users/ihsan/workspaces/week1workspace/jdbcintro/target/classes/application.properties"));
			 ...
			 * DriverManager class will attempt to load the driver classes referred in the jdbc.drivers
			 */
