...
-- Some functions/stored procedures
CREATE OR REPLACE PROCEDURE RESOLVE_REIMBURSEMENT
(r_id IN NUMBER, r_status_id IN NUMBER, r_reslvr IN NUMBER)
AS
BEGIN
UPDATE ERS_REIMBURSEMENT
SET reimb_resolved = CURRENT_TIMESTAMP, reimb_resolver = r_reslvr,
reimb_status_id = r_status_id
WHERE reimb_id = r_id;
END;
/
...
--VALUES ('150.50', 'Need to get my money', 7320, 1, 1);
--
--INSERT INTO ERS_REIMBURSEMENT (REIMB_AMOUNT, REIMB_DESCRIPTION, 
--REIMB_AUTHOR, REIMB_STATUS_ID, REIMB_TYPE_ID) 
--VALUES ('50', 'Long way from home', 7320, 1, 2);
--
--INSERT INTO ERS_REIMBURSEMENT (REIMB_AMOUNT, REIMB_DESCRIPTION, 
--REIMB_AUTHOR, REIMB_STATUS_ID, REIMB_TYPE_ID) 
--VALUES ('10.50', 'Hungry man', 7320, 1, 3);
--
--INSERT INTO ERS_REIMBURSEMENT (REIMB_AMOUNT, REIMB_DESCRIPTION, 
--REIMB_AUTHOR, REIMB_STATUS_ID, REIMB_TYPE_ID)
--VALUES ('1500.50', 'Certification reimbursement', 7320, 1, 4);
--
--INSERT INTO ERS_REIMBURSEMENT (REIMB_AMOUNT, REIMB_DESCRIPTION, 
--REIMB_AUTHOR, REIMB_STATUS_ID, REIMB_TYPE_ID)
--VALUES ('2500.50', 'Certification reimbursement', 7320, 1, 4);
--
--INSERT INTO ERS_REIMBURSEMENT (REIMB_AMOUNT, REIMB_DESCRIPTION, 
--REIMB_AUTHOR, REIMB_STATUS_ID, REIMB_TYPE_ID)
--VALUES ('2500.50', 'Certification reimbursement', 7340, 1, 4);
--
--INSERT INTO ERS_REIMBURSEMENT (REIMB_AMOUNT, REIMB_AUTHOR, REIMB_STATUS_ID, 
--REIMB_TYPE_ID)
--VALUES ('250.50', 7320, 1, 4);
--
--INSERT INTO ERS_REIMBURSEMENT (REIMB_AMOUNT, REIMB_DESCRIPTION, REIMB_RECEIPT,
--REIMB_AUTHOR, REIMB_STATUS_ID, REIMB_TYPE_ID)
--VALUES ('10.50', 'food', null, 7342, 1, 3);
--
--INSERT INTO ERS_REIMBURSEMENT (REIMB_AMOUNT, REIMB_DESCRIPTION, 
--REIMB_AUTHOR, REIMB_STATUS_ID, REIMB_TYPE_ID)
--VALUES ('2500.50', null, 7340, 1, 4);