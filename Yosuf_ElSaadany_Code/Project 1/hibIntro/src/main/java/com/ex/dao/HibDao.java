...
public class HibDao {
	...
	/*
	 * Query API
	 * Queries use the hibernate Query Language - not to be confused with
	 * SQL! The main difference is that HQL uses class and property names
	 * instead of table and column names, respectively.
	 */
