...
public class ForwardRedirect extends HttpServlet {
	...
	public void destroy() {
		System.out.println("In servlet - destory()");
		super.destroy();
	}
 ...
 * 
 * Redirect:
 * 		- two steps --> the web app instructs the browser to fetch
 ...
 * 		- objects placed in the request scope are not available to the second request
