...
public class HibDao {
	 ...
	 * Criteria objects. This is a very convenient approach for functionality
	 * like "search" where there is a variable number of conditions to be placed
	 * upon the result set
	 */
	...
	/*
	 * QUERY API
	 * Queries use the Hibernate Query Language - not to be confused with SQL!
	 * The main difference is that HQL uses class and property names instead of table
	...
	public List<Student> queryDemo(String name){
		...
		// the from Student maps it to the Student object in POJO
