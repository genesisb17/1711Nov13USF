...
public class ConnectionFactory {
	...
	public Connection getConnection() {
		...
		try {
			prop.load(new FileReader("C:/Users/Moorah/my_git_repos/"
					+ "1711Nov13USF/Matt_Lou_Code/week2/jdbcintro/src/main/"
		 ...
		 * set of JDBC drivers. As part of its initialization, the DriverManager class
		 * will attempt to load the driver classes 
