...
public class MultithreadingIntro {
	 ...
	 * 		A thread is in the blocked state when it tries to access a protected section of code that's currently
	 ...
	 * Terminated - a thread terminates because either it finishes its thread of excecution naturally or
	 * 		because some unusual or exceptional event occurs. ie segmentation fault or unhandled exception
	 */
