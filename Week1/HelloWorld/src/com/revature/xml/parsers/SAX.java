...
public class SAX {
	 ...
	 * the ML file step-by-step. It is much more suitable
	 * for larger XML files. SAX XML parsers fires an event
	 * when it encounters an opening tag, element or attribute
	...
	public static void main(String[] args) {
		...
		try {
			...
			DefaultHandler handler = new DefaultHandler() {
				...
				public void startElement(String uri, String locaName, String name, Attributes attributes) {
