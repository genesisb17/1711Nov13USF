...
public class ConnectionFactory {
	...
	public Connection getConnection() {
		...
		try {
			prop.load(new FileReader("C:/Users/Nick/Nicholas_git_repos/1711Nov13USF/Nicholas_Bell_Code/ERS/Employee_Reimbursement_Service/src/main/resources/application.properties"));
