...
public class ConnectionFactory {
	...
	//--synchronized to prevent 2 threads from creating thread object simultaneously
	...
	public Connection getConnection() {
		...
		try {
			prop.load(new FileReader("C:/Users/dbkel/eclipse-workspace/BankWithDatabase/src/main/resources/application.properties"));
