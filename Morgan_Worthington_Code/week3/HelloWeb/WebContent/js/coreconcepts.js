 ...
 * loosely typed (don't specify data types)
 * value types:
 * 
 * number, string, object, boolean, null, NaN (not  a number), undefined
 ...
 * -length number - not the actual # of elements stored in the array but 1 larger than the last index
 */
