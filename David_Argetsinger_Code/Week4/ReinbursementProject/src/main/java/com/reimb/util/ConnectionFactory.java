...
public class ConnectionFactory {
	...
	public Connection getConnection(){
		...
		try{
			...
			prop.load(new FileReader("C:/Users/Moo Rah/my_git_repos/1711Nov13USF/David_Argetsinger_Code/Week4/ReinbursementProject/src/main/java/com/reimb/util/database.properties"));
