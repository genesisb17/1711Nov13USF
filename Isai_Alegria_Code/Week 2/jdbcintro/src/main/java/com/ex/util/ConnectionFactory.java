...
public class ConnectionFactory {
	...
	public Connection getConnection() {
		...
		try {
			prop.load(new FileReader("C:/Users/eesig/my_git_repos/1711Nov13USF/Isai_Alegria_Code/Week 2/jdbcintro/src/main/resources/application.properties"));
			 ...
			 * referenced in the jdbc drivers system properties
			 */
