...
public class StudentIO {
	...
	public static void main(String[] args) {
		...
		/*Student s1 = new Student("Wezley Singleton", 27);
		Student s2 = new Student("Bill Murray", 68);
		Student s3 = new Student("Jack Nicholson", 75);
		writeStudent(s1);
		writeStudent(s2);
		writeStudent(s3);*/
	...
	static void writeStudent(Student student) {
		...
		// try-with-resources (automatically closes any resources specified)
